...
CKPT_NAME="base_pocl_fkl/t2/1064"
...
# data
DATA_DIR="${BASE_PATH}/processed_data/dolly/full/gpt2/train3/"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/base_pocl_fkl/t3"
# seed
SEED=10
